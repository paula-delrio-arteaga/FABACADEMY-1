...
## Project description: 
 ...
 - The material is "alive" in a sense, the data that's feeded everyday leaves a residue that start to emerge like patterns on the dyes fabric

 - Analysing the residue
